...
class DisplayableFluid : public Fluid {
    ...
    double _scale;      //scale fluid to the size of the window


    DisplayableFluid(int size, double scale, double dt, double diffusion, double viscosity, double fade_degree,
